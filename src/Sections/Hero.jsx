    ...
    <section className="flex gap-8">
      <div className="m-6 sm:m-8 md:w-1/2 lg:m-12">
        <div className="font-matangi relative z-10 mb-4 text-xl leading-relaxed font-bold underline-offset-4 md:mb-8 md:text-3xl lg:mb-12 lg:text-4xl dark:text-gray-200">
          <img src="/girl.jpg" alt="student" className="rounded-xl md:hidden" />
          <div className="absolute right-0 bottom-3 w-[40%] text-amber-950 md:static md:w-full md:text-black dark:md:text-white">
      ...
      <div className="m-4 hidden w-1/2 md:m-8 md:inline lg:m-12">
        <img
          src="/girl.jpg"
          alt="quote-image"
          className="md: aspect-[2/3] w-[70%] self-center rounded-2xl object-cover object-bottom"
        />
      </div>
    </section>
  );
